...
def calculate_hedge_results(df_hedge, cotacao_dolar):
    ...
    # Para operações ATIVAS - calcular com cotação atual
    if 'Status' in df_result.columns:
        mask_ativo = df_result['Status'] == 'Ativo'
    ...
    if df_hedge_raw.empty:
        ...
        with col1:
            ...
            if 'Status' in df_hedge_filtered.columns:
                if status_selected == 'Ativo':
                    ativos = len(df_hedge_filtered[df_hedge_filtered['Status'] == 'Ativo'])
